...
options:
    ...
    purge:
        description:
        - Immediately purge volume after delete. If False, will remain under Deleted items for 8 hours.
        - Optional variable for Delete Volume task
        choices: ['True', 'False']
        default: 'True'
        type: str
'''
...
EXAMPLES = """
   ...
   - name: Delete Volume without purge
     na_elementsw_volume:
       hostname: "{{ elementsw_hostname }}"
       username: "{{ elementsw_username }}"
       password: "{{ elementsw_password }}"
